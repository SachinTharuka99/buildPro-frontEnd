$(function() {
	...
	gradient.addColorStop(1, '#6db664');
	new Chart(ctx3, {
		type: 'bar',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
	...
	new Chart(ctx4, {
		...
		data: {
			...
			datasets: [{
				label: '# of Votes',
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: ['#fb1c52', '#6db664', '#2dce89', '#ff5b51', '#fcbf09', '#5b7fff']
			}]
		},
		options: {
			maintainAspectRatio: false,
	...
	new Chart(ctx5, {
		...
		data: {
			...
			datasets: [{
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: [ '#6db664', '#2dce89', '#ff5b51', '#fcbf09', '#5b7fff']
			}, {
